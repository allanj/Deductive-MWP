from src.data.gen_dataset import GenerationDataset
...
def parse_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--train_file', type=str, default="data/gen_train.json")
    parser.add_argument('--dev_file', type=str, default="data/gen_val.json")
...
def main():
    ...
    dataset = GenerationDataset(tokenizer=tokenizer, file=conf.train_file, number=conf.train_num)
    print("[Data Info]  Reading validation data", flush=True)
    eval_dataset = GenerationDataset(tokenizer=tokenizer, file=conf.dev_file, number=conf.dev_num)
