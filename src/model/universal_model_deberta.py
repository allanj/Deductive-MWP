from transformers.models.deberta_v2 import DebertaV2Model, DebertaV2PreTrainedModel, DebertaV2Config
import torch.nn as nn
import torch
import torch.utils.checkpoint
from src.model.universal_model_roberta import get_combination_mask, UniversalOutput, get_negative_mask, get_intermediate_value_mask, compute_intermediate_values
...
class UniversalModel_Deberta(DebertaV2PreTrainedModel):
    ...
    def forward(self,
        ...
        outputs = self.deberta( # batch_size, sent_len, hidden_size,
            input_ids,
